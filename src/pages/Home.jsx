        ...
        <div className="flex flex-col gap-2 m-5">
            <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-6 w-[100%] mt-4 h-fit justify-center sm:flex-row sm:flex-wrap sm:gap-3">
                    <img className="hover:scale-95 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={book} alt="book" />
                    <img className="hover:scale-95 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={coding} alt="coding" />
                    <img className="hover:scale-95 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={design} alt="design" />
                </div>
            </div>
            <div className="flex flex-col">
                ...
                <div className="flex-col">
                    ...
                    <div className="flex flex-col gap-6 justify-center mt-4 sm:flex-row sm:flex-wrap sm:gap-3">
                        <img className="hover:scale-99 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={light} alt="light" />
                        <img className="hover:scale-99 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={laptop} alt="laptop" />
                        <img className="hover:scale-99 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={microphone} alt="microphone" />
                    </div>
                </div>
            </div>
            <div className="flex-col">
                ...
                <div className="flex-col">
                    ...
                    <div className="flex flex-col gap-6 justify-center mt-4 sm:flex-row sm:flex-wrap sm:gap-3 lg:gap-5">
                        <img className="hover:scale-99 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={place} alt="place" />
                        <img className="hover:scale-99 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={smile} alt="smile" />
                        <img className="hover:scale-99 rounded-2xl w-[95%] mx-auto h-72 sm:w-[48%] sm:h-[20rem] lg:w-[32%]" src={worker} alt="worker" />
                    </div>
                </div>
            </div>
        </div>
