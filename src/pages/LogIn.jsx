    ...
    <div className="py-4 bg-[#f5f4f4] flex flex-col justify-center items-center pb-14">
      ...
      >
        ...
        <input
          ...
          name="username"
          id="username"
          className="border-1 w-[95%] mx-auto rounded-[0.5rem] mt-2 h-10 pl-2 sm:py-6 sm:mt-3"
          required
          autoFocus
          maxLength={24}
          value={username}
        ...
        <button
          type="submit"
          className="bg-[#c4671b] mt-6 w-[95%] mx-auto rounded-[0.6rem] p-1 hover:bg-amber-800 text-white "
        >
          Log In
        </button>
        <button
